---
title: 3D AOI-derived Cognitive Workload Evaluation for Human Robot Collaborative Assembly Tasks
authors:
  - name: Junyan Xiong
    notes: ["1", "2"]
  - name: Naiyi Feng
  ...
  - name: Daqiang Guo
    notes: ["1", "*"]
conference: Submission to Robotics and Computer Integrated Manufacturing
notes:
  - symbol: "1"
    text: Thrust of Smart Manufacturing, System Hub, HKUST(GZ)
  - symbol: "2"
    text: College of Future Technology, HKUST(GZ)
  - symbol: "*"
